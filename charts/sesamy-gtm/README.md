...
| gtm.image.tag | string | `"3.2.0"` | The image tag of the [release](https://console.cloud.google.com/artifacts/docker/cloud-tagging-10302018/us/gcr.io/gtm-cloud-image?pli=1) |
...
| proxy.image.tag | string | `"1.29.1-alpine"` | The image [tag](https://hub.docker.com/_/nginx) |
