...
|------------|------|---------|
| oci://registry-1.docker.io/bitnamicharts | pinniped(pinniped) | 2.4.17 |
...
| cloudflared.image.tag | string | `"2025.5.0"` | Image tag |
...
| cloudflaredSplitter.image.tag | string | `"1.28.0"` | Image tag |
