...
|------------|------|---------|
| oci://registry-1.docker.io/bitnamicharts | pinniped(pinniped) | 2.4.9 |
...
| cloudflared.image.tag | string | `"2025.2.1"` | Image tag |
...
| cloudflaredSplitter.image.tag | string | `"1.27.4"` | Image tag |
